...
import 'package:clean_flutter/features/number_trivia/data/data_sources/number_trivia_local_datasource.dart';
import 'package:clean_flutter/features/number_trivia/data/data_sources/number_trivia_remote_datasource.dart';
...
void main() {
  ...
  group('getConcreteNumberTrivia', () {
    ...
    runTestsOnline(() {
      ...
      test(
          'should cache data locally when the call to the remote data is successful',
          () async {
        when(mockRemoteDataSource.getConcreteNumberTrivia(any))
            .thenAnswer((_) async => tNumberTriviaModel);
